...
from models.mcts.MctsGenerator import Generator
from models.mcts.MctsDataLoader import DataLoader, DisDataloader
...
class MctsGan(Gan):
    ...
    def train_oracle(self):
        ...
        self.log = open('experiment-log-mcts.csv', 'w')
    ...
    def train_cfg(self):
        ...
        self.pre_epoch_num = 80
        self.adversarial_epoch_num = 100
        self.log = open('experiment-log-mcts-cfg.csv', 'w')
        generate_samples(self.sess, self.generator, self.batch_size, self.generate_num, self.generator_file)
        self.gen_data_loader.create_batches(self.oracle_file)
        self.oracle_data_loader.create_batches(self.generator_file)
        print('start pre-train generator:')
    ...
    def init_real_trainng(self, data_loc=None):
        ...
        vocabulary = Vocabulary.from_word_set(word_set, self.sequence_length, self.vocab_size)
        vocabulary.tokens_to_codes_file(tokens, self.oracle_file)
    ...
    def train_real(self, data_loc=None):
        ...
        vocabulary = self.init_real_trainng(data_loc)
        ...
        self.pre_epoch_num = 80
        self.adversarial_epoch_num = 100
        self.log = open('experiment-log-mcts-real.csv', 'w')

        # TODO: Double check we don't need following line
        # which generates fake samples to train the discriminator
        # generate_samples(self.sess, self.generator, self.batch_size, self.generate_num, self.generator_file)
        ...
        #         generate_samples(self.sess, self.generator, self.batch_size, self.generate_num, self.generator_file)
        #         #get_real_test_file()
        #         vocabulary.codes_file_to_real_text_file(self.generator_file, self.test_file)
        #         # TODO: print out some samples
        #         self.evaluate()

        # Train MCTS generator
        print('Train alpha-zero mcts')
        self.generator.learn_mcts(self.sess, self.gen_data_loader)
